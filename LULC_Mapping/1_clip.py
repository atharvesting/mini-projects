...
Clipping Methodology:
    ...
    2. Open Image:      Load the satellite band data.
...
# The box is wrapped using the specific CRS 'EPSG:4326' which indicates that the coordinates are in standard latitude/longitude.
